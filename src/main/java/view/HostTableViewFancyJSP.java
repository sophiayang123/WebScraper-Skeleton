 ...
 * @author Shariar
 */
@WebServlet(name = "HostViewFancyJSPBetter", urlPatterns = {"/HostViewFancyJSPBetter"})
public class HostTableViewFancyJSP extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp)
            throws ServletException, IOException {
        log("POST");
        //get the path of request, for example this page will likely be /HostTableViewFancyJSP
        //String path = req.getServletPath();
